...
To deal with the database from PHP, we are going to depend on `Doctrine`_, a set of libraries that help developers manage databases: Doctrine DBAL (a database abstraction layer), Doctrine ORM (a library to manipulate our database content using PHP objects), and Doctrine Migrations.
...
.. sidebar:: Going Further
    ...
    * `Databases and Doctrine ORM`_ in Symfony applications;

    * `SymfonyCasts Doctrine tutorial`_;

    * `Working with Doctrine Associations/Relations`_;

    * `DoctrineMigrationsBundle docs`_.

.. _`Doctrine`: https://www.doctrine-project.org/
.. _`Databases and Doctrine ORM`: https://symfony.com/doc/current/doctrine.html
.. _`SymfonyCasts Doctrine tutorial`: https://symfonycasts.com/screencast/symfony-doctrine/install
.. _`Working with Doctrine Associations/Relations`: https://symfony.com/doc/current/doctrine/associations.html
