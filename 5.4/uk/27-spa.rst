...
Змінна середовища ``API_ENDPOINT`` має вказувати на веб-сервер веб-сайту, де у нас є кінцева точка API за посиланням ``/api``. Ми налаштуємо її належним чином, коли незабаром виконаємо команду ``yarn``.
