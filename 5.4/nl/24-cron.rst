...
Merk op dat crons in alle Platform.sh branches opgezet zijn. Als je niet wilt dat sommige crons op niet-productie omgevingen worden uitgevoerd, controleer dan de ``$PLATFORM_BRANCH`` omgevingsvariabele:
