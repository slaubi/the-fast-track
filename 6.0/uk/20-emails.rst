...
Змінні середовища ``SYMFONY_DEFAULT_ROUTE_HOST`` і ``SYMFONY_DEFAULT_ROUTE_PORT`` автоматично встановлюються локально під час використання ``symfony`` CLI й визначаються на основі конфігурації у Platform.sh.
