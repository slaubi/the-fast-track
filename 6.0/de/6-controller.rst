...
Das ``#[Route('/conference', name: 'conference')]``-Attribut macht die ``index()``-Methode zu einem Controller (die Konfiguration befindet sich neben dem Code, den sie konfiguriert).
