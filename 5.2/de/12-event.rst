...
.. sidebar:: Weiterführendes
    ...
    * Der `Request-Response Ablauf <https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request>`_ in Symfony-Anwendungen;

    * Die `eingebauten Symfony HTTP-Events <https://symfony.com/doc/current/reference/events.html>`_;

    * Die `eingebauten Events der Symfony Console <https://symfony.com/doc/current/components/console/events.html>`_.
