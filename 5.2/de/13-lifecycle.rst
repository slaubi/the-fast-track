...
Um die Eindeutigkeit für slugs zu garantieren, benutzen wir Validatoren. Füge die Symfony-Validator-Komponente hinzu:
...
.. sidebar:: Weiterführendes
    ...
    * Das `Doctrine Eventsystem <https://symfony.com/doc/current/doctrine/events.html>`_ (Lifecycle Callbacks und Listener, Entity Listener und Lifecycle Subscriber);

    * Die `String-Komponenten-Dokumentation; <https://symfony.com/doc/current/components/string.html>`_;

    * Der `Service-Container <https://symfony.com/doc/current/service_container.html>`_;

    * Das `Symfony Services Cheat Sheet <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/services_en_42.pdf>`_.
