...
Wir haben keine Zeit mit dem Design des User-Interfaces verbracht. Um wie ein Profi zu arbeiten, werden wir einen modernen Stack verwenden, der auf `Webpack <https://webpack.js.org/>`_ basiert. Und um einen Symfony-Touch hinzuzufügen und die Integration mit der Anwendung zu erleichtern, installieren wir *Webpack Encore*:
...
Anstatt einfaches CSS zu verwenden, wechseln wir zu `Sass <https://sass-lang.com/>`_:
...
Um mit vernünftigen Voreinstellungen zu beginnen und eine "responsive" Website zu erstellen, kann uns ein CSS-Framework wie `Bootstrap <https://getbootstrap.com/>`_ viel Arbeit abnehmen. Installiere es als Paket:
...
.. sidebar:: Weiterführendes
    ...
    * `Webpack-Dokumentation <https://webpack.js.org/concepts/>`_;

    * `Symfony Webpack Encore Dokumentation <https://symfony.com/doc/current/frontend.html>`_;
