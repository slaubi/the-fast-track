...
.. sidebar:: Andare oltre
    ...
    * Documentazione su `Workflows e State Machine <https://symfony.com/doc/current/workflow/workflow-and-state-machine.html>`_ e quando scegliere una o l'altra;

    * Documentazione su `Symfony Workflow <https://symfony.com/doc/current/workflow.html>`_.
