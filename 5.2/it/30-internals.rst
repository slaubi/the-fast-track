...
Chi non conosce il debug a step può leggere `l'ottima guida per Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`_, che spiega tutto in modo visuale.

.. sidebar:: Andare oltre

    * `Documentazione sul debug a step di Xdebug <https://xdebug.org/docs/step_debug>`_;

    * `Debug con Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`_.
