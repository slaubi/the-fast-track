...
Siccome stiamo usando un validatore per assicurare l'unicità degli slug, abbiamo bisogno di aggiungere il componente Validator di Symfony:
...
.. sidebar:: Andare oltre
    ...
    * Il `sistema di eventi di Doctrine <https://symfony.com/doc/current/doctrine/events.html>`_ (ciclo di vita delle callback, dei listener e dei subscriber);

    * `Documentazione del componente String <https://symfony.com/doc/current/components/string.html>`_;

    * Il `Service container <https://symfony.com/doc/current/service_container.html>`_;

    * `Cheat Sheet di Symfony Services <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/services_en_42.pdf>`_.
