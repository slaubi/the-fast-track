...
Per consumare i messaggi da PostgreSQL, dobbiamo eseguire il comando ``messenger:consume``. Su SymfonyCloud, questo è il ruolo di un *worker*:
...
.. sidebar:: Andare oltre
    ...
    * Tutorial SymfonyCasts su `Messenger <https://symfonycasts.com/screencast/messenger>`_;

    * L'architettura `Enterprise service bus <https://en.wikipedia.org/wiki/Enterprise_service_bus>`_ e il `pattern CQRS <https://martinfowler.com/bliki/CQRS.html>`_;

    * `Documentazione su Symfony Messenger <https://symfony.com/doc/current/messenger.html>`_;
