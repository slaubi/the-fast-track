...
Attivare il supporto alla chat Slack:
...
Lasciatemi spiegare una piccola questione che dovremmo risolvere. Per ogni commento riceviamo un'e-mail e un messaggio Slack. Se il messaggio Slack è errato (id canale sbagliato, token sbagliato, ....), il messenger riproverà tre volte prima scartare il messaggio. Ma siccome l'email viene inviata per prima, riceveremo tre email e nessun messaggio Slack. Un modo per risolvere il problema è quello di inviare i messaggi Slack in modo asincrono, così come le email:
...
Non appena tutto è asincrono, i messaggi diventano indipendenti. Abbiamo anche abilitato gli SMS asincroni nel caso in cui volessimo essere avvisati sul telefono.
...
.. sidebar:: Andare oltre
    ...
    * `Messaggi flash di Symfony <https://symfony.com/doc/current/controller.html#flash-messages>`_.
