...
.. sidebar:: Idąc dalej
    ...
    * `Cykl życia Request-Response <https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request>`_ w aplikacjach Symfony;

    * `Wbudowane zdarzenia Symfony HTTP <https://symfony.com/doc/current/reference/events.html>`_;

    * `Wbudowane zdarzenia Symfony Console <https://symfony.com/doc/current/components/console/events.html>`_.
