...
Kolejnym sposobem na podążanie za wykonywanym kodem jest **debugger krokowy**, jak np. `Xdebug <https://xdebug.org>`_. Debugger krokowy pozwala na interaktywny spacer po kodzie PHP, żeby zweryfikować przepływ kodu oraz sprawdzić struktury danych. Jest to bardzo przydatne podczas debugowania niespodziewanych zachowań i zastępuje popularną technikę "var_dump()/exit()".
...
Jeśli debuggery krokowe są dla ciebie nowością, przeczytaj ten `świetny poradnik dla Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`, który wszystko wizualnie wyjaśnia.

.. sidebar:: Idąc dalej

    * `Dokumentacja debuggera krokowego Xdebug <https://xdebug.org/docs/step_debug>`_;

    * `Debugowanie z Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`_.
