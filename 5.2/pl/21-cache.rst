...
Aby przetestować strategię pamięci podręcznej HTTP, włącz zwrotny serwer pośredniczący (ang. reverse proxy) Symfony HTTP:
...
.. sidebar:: Idąc dalej
    ...
    * `Pamięć podręczna HTTP (ang. HTTP cache) w SymfonyCloud <https://symfony.com/doc/current/cloud/cookbooks/cache.html>`_.
