...
.. sidebar:: Idąc dalej
    ...
    * `Dokumentacja EasyAdmin <https://symfony.com/doc/3.x/bundles/EasyAdminBundle/index.html>`_;

    * `Dostępne ustawienia w konfiguracji Symfony <https://symfony.com/doc/current/reference/configuration/framework.html>`_;

    * `Magiczne metody PHP <https://www.php.net/manual/en/language.oop5.magic.php>`_.
