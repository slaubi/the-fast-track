...
Om in PHP met een database te werken gaan we gebruik maken van `Doctrine`_ , een set libraries die ons, ontwikkelaars, helpt om met databases om te gaan:
...
.. sidebar:: Verder gaan
    ...
    * `Databases en Doctrine ORM <https://symfony.com/doc/current/doctrine.html>`_ in Symfony applicaties;

    * `SymfonyCasts Doctrine tutorial <https://symfonycasts.com/screencast/symfony-doctrine/install>`_;

    * `Werken met Doctrine Associations/Relations <https://symfony.com/doc/current/doctrine/associations.html>`_;

    * `DoctrineMigrationsBundle documentatie <https://symfony.com/doc/current/bundles/DoctrineMigrationsBundle/index.html>`_.
