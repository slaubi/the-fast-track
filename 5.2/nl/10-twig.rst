...
.. sidebar:: Verder gaan
    ...
    * `Twig documentatie <https://twig.symfony.com/doc/2.x/>`_;

    * `Templates maken en gebruiken <https://symfony.com/doc/current/templates.html>`_ in Symfony applicaties;

    * `SymfonyCasts Twig tutorial <https://symfonycasts.com/screencast/symfony/twig-recipe>`_;

    * `Twig functies en filters die alleen beschikbaar zijn in Symfony <https://symfony.com/doc/current/reference/twig_reference.html>`_;

    * De `AbstractController base controller <https://symfony.com/doc/current/controller.html#the-base-controller-classes-services>`_.
