...
Een paar annotations op de Conference-class is alles wat we nodig hebben om de API te configureren:
...
De belangrijkste annotatie, ``@ApiResource``, configureert de API voor conferenties. Het beperkt de mogelijke handelingen tot ``get`` en configureert verschillende dingen, zoals welke velden moeten worden weergegeven en in welke volgorde de conferenties moeten staan.
...
Dezelfde soort annotaties worden gebruikt om de class te configureren.
