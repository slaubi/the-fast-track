...
Om te beginnen met het vertalen van de website, moeten we het Translation Symfony-component installeren:
...
In plaats van de vertaalbestanden met de hand aan te maken, gebruik je het ``translation:update`` commando:
...
.. sidebar:: Verder gaan
    ...
    * `Berichten vertalen met behulp van de ICU-formattering <https://symfony.com/doc/current/translation/message_format.html>`_;

    * `Twig vertaalfilters gebruiken <https://symfony.com/doc/current/translation/templates.html#translation-filters>`_.
