...
EasyAdmin genereert automatisch een op specifieke controllers gebaseerd admin-gedeelte voor je applicatie. Creëer een nieuwe ``src/Controller/Admin/`` directory waar we deze controllers zullen opslaan:
...
.. sidebar:: Verder gaan
    ...
    * `EasyAdmin-documentatie <https://symfony.com/doc/3.x/bundles/EasyAdminBundle/index.html>`_;
    ...
    * `PHP magic methodes <https://www.php.net/manual/en/language.oop5.magic.php>`_.
