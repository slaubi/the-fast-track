...
Omdat we een validator gebruiken om de uniekheid van slugs te garanderen, moeten we het Symfony Validator component toevoegen:
...
.. sidebar:: Verder gaan
    ...
    * Het `Doctrine event system <https://symfony.com/doc/current/doctrine/events.html>`_ (lifecycle callbacks en listeners, entity listeners en lifecycle subscribers);

    * De `documentatie voor het String-component <https://symfony.com/doc/current/components/string.html>`_;

    * De `Service container <https://symfony.com/doc/current/service_container.html>`_;

    * De `Symfony Services Cheat Sheet <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/services_en_42.pdf>`_ ).
