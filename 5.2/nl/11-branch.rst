...
#. Werk de PHP-configuratie bij indien nodig (voeg bijvoorbeeld de PostgreSQL PHP-extensie toe);

#. Update de infrastructuur op Docker en SymfonyCloud indien nodig (voeg bijvoorbeeld de PostgreSQL-service toe);
