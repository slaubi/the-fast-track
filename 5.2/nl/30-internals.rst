...
Als je nieuw bent met stap-debuggers, lees dan de `uitstekende tutorial voor Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`_, waarin alles visueel wordt uitgelegd.

.. sidebar:: Verder gaan

    * `De Xdebug Step Debugging documentatie <https://xdebug.org/docs/step_debug>`_;

    * `Debuggen met Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`_.
