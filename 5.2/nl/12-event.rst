...
.. sidebar:: Verder gaan
    ...
    * De `Request-Response Flow <https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request>`_ in Symfony toepassingen;

    * De `ingebouwde Symfony HTTP-events <https://symfony.com/doc/current/reference/events.html>`_;

    * De `ingebouwde Symfony Console-events <https://symfony.com/doc/current/components/console/events.html>`_.
