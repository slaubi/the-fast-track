...
Dacă este prima dată când folosești un step debugger, citește `tutorialul excelent pentru Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`_,  care explică totul vizual.

.. sidebar:: Mergând mai departe

    * `Documentația Xdebug Step Debugging <https://xdebug.org/docs/step_debug>`_;

    * `Debugging cu Visual Studio Code <https://code.visualstudio.com/Docs/editor/debugging>`_.
