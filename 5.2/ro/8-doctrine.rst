...
Aproape toate pachetele instalate au o configurație în directorul ``config/packages/``. De cele mai multe ori, valorile implicite au fost alese cu atenție pentru a funcționa pentru majoritatea aplicațiilor.
...
Vom modifica în continuare fișierul ``.env`` pentru a configura ``DATABASE_URL`` să utilizeze PostgreSQL:
...
.. sidebar:: Mergând mai departe
    ...
    * `Documentația pentru DoctrineMigrationsBundle <https://symfony.com/doc/current/bundles/DoctrineMigrationsBundle/index.html>`_;
