...
De asemenea, trebuie să oprești consumatorul de mesaje, deoarece nu știe încă de captatorul de e-mail:

.. code-block:: bash

    $ symfony console messenger:stop-workers

Și pornește-l din nou. „MAILER_DSN“ este acum expus automat:
...
Symfony vine cu afirmații care ușurează astfel de teste. Iată un exemplu de test care demonstrează câteva posibilități:
...
.. sidebar:: Mergând mai departe
    ...
    * `Documentația SymfonyCloud despre e-mailuri <https://symfony.com/doc/current/cloud/services/emails.html>`_.
