...
Pentru a testa strategia de cache HTTP, activează reverse proxy-ul pus la dispoziție de componenta Symfony HTTP:
...
.. sidebar:: Mergând mai departe
    ...
    * `HTTP Cache în SymfonyCloud <https://symfony.com/doc/current/cloud/cookbooks/cache.html>`_.
