...
Pe mașina locală, nu uita să dezactivezi memoria cache HTTP în ``config/packages/framework.yaml`` atunci când profilezi: dacă nu, vei profila stratul cache HTTP Symfony în loc de propriul cod:
