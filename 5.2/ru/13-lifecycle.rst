...
Поскольку мы используем валидатор, чтобы гарантировать уникальность слагов, нам нужно добавить компонент Symfony Validator:
...
.. sidebar:: Двигаемся дальше
    ...
    * `Документация компонента String <https://symfony.com/doc/current/components/string.html>`_;
