...
.. sidebar:: Двигаемся дальше
    ...
    * `Документация по Twig <https://twig.symfony.com/doc/2.x/>`_;

    * `Создание и использование шаблонов <https://symfony.com/doc/current/templates.html>`_ в Symfony-приложениях;

    * `Учебный видеоролик по Twig на SymfonyCasts <https://symfonycasts.com/screencast/symfony/twig-recipe>`_;

    * `Функции и фильтры Twig доступные только в Symfony <https://symfony.com/doc/current/reference/twig_reference.html>`_;

    * `Базовый контроллер AbstractController <https://symfony.com/doc/current/controller.html#the-base-controller-classes-services>`_.
