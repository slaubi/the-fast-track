...
Было бы неплохо, если бы проект каким-то образом был связан с Symfony и конференциями, так как книга должна быть опубликована на конференции SymfonyCon 2019 в Амстердаме. Как насчёт `гостевой книги <https://en.wikipedia.org/wiki/Guestbook>`_  или ливр д'ор, как мы называем её по-французски? Мне нравится это старое доброе ощущение разработки гостевой книги в 2019 году!
...
* 550 логических строк PHP-кода (LLOC) по данным `PHPLOC <https://github.com/sebastianbergmann/phploc>`_;
...
Клонируйте `репозиторий гостевой книги <https://github.com/the-fast-track/book-5.2-2>`_ на свой компьютер:
