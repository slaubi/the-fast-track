...
.. sidebar:: Going Further
    ...
    * The `Request-Response Flow <https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request>`_ in Symfony applications;

    * The `built-in Symfony HTTP events <https://symfony.com/doc/current/reference/events.html>`_;

    * The `built-in Symfony Console events <https://symfony.com/doc/current/components/console/events.html>`_.
