...
.. sidebar:: Going Further
    ...
    * `Creating and Using Templates <https://symfony.com/doc/current/templates.html>`_ in Symfony applications;

    * `SymfonyCasts Twig tutorial <https://symfonycasts.com/screencast/symfony/twig-recipe>`_;

    * `Twig functions and filters only available in Symfony <https://symfony.com/doc/current/reference/twig_reference.html>`_;

    * The `AbstractController base controller <https://symfony.com/doc/current/controller.html#the-base-controller-classes-services>`_.
