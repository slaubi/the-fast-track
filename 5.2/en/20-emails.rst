...
The default ``NotificationEmail`` template uses `Inky <https://get.foundation/emails/docs/inky.html>`_ instead of HTML to design emails. It helps create responsive emails that are compatible with all popular email clients. 
...
.. sidebar:: Going Further 
    ...
    * The `Inky templating language docs <https://get.foundation/emails/docs/inky.html>`_; 
 
    * The `Environment Variable Processors <https://symfony.com/doc/current/configuration/env_var_processors.html>`_; 
 
    * The `Symfony Framework Mailer documentation <https://symfony.com/doc/current/mailer.html>`_; 
