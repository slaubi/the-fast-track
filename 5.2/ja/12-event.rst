...
.. sidebar:: より深く学ぶために
    ...
    * `Symfony アプリケーションの Request-Response の流れ <https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request>`_

    * `ビルトインされた Symfony HTTP のイベント <https://symfony.com/doc/current/reference/events.html>`_;

    * `ビルトインされた Symfony Console のイベント <https://symfony.com/doc/current/components/console/events.html>`_.
