...
Дозвольте мені пояснити невелику проблему, яку ми маємо вирішити. Для кожного коментаря ми отримуємо повідомлення електронної пошти й повідомлення Slack. Якщо в повідомленні Slack є помилки (неправильний ідентифікатор каналу, неправильний токен, ...), Messenger буде відправляти повідомлення повторно три рази, перш ніж відкине його. Але оскільки повідомлення електронної пошти відправляється першим, ми отримаємо 3 повідомлення електронної пошти й жодних повідомлень Slack. Один зі способів виправити це — відправляти повідомлення Slack асинхронно, як повідомлення електронної пошти:
...
Як тільки все стає асинхронним, повідомлення стають незалежними. Ми також увімкнули асинхронні SMS-повідомлення на той випадок, якщо ви також хочете отримувати сповіщення на ваш телефон.
...
.. sidebar:: Йдемо далі
    ...
    * `Миттєві повідомлення Symfony <https://symfony.com/doc/current/controller.html#flash-messages>`_.
