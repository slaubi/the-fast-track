...
Упорядкування списку конференцій за роками може полегшити перегляд. Ми могли б створити спеціальний метод для отримання та сортування всіх конференцій, але замість цього ми змінимо реалізацію методу ``findAll()`` за замовчуванням, щоб переконатися, що сортування застосовується скрізь:
...
.. sidebar:: Йдемо далі
    ...
    * `Життєвий цикл Request-Response <https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request>`_ у застосунках Symfony.

    * `Вбудовані HTTP-події Symfony <https://symfony.com/doc/current/reference/events.html>`_;

    * `Вбудовані події Symfony Console <https://symfony.com/doc/current/components/console/events.html>`_.
