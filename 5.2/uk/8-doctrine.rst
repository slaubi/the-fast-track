...
Для роботи з базою даних в PHP ми будемо використовувати `Doctrine`_, — набір бібліотек, які допомагають розробникам працювати з базами даних:
...
.. sidebar:: Йдемо далі
    ...
    * `Бази даних і Doctrine ORM <https://symfony.com/doc/current/doctrine.html>`_ у застосунках із Symfony;

    * `Навчальний посібник SymfonyCasts: Doctrine <https://symfonycasts.com/screencast/symfony-doctrine/install>`_;

    * `Робота з асоціаціями/зв'язками Doctrine <https://symfony.com/doc/current/doctrine/associations.html>`_;

    * `Документація по Doctrine Migrations <https://symfony.com/doc/current/bundles/DoctrineMigrationsBundle/index.html>`_.
