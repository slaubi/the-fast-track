...
.. sidebar:: Йдемо далі
    ...
    * `Система подій Doctrine <https://symfony.com/doc/current/doctrine/events.html>` _ (зворотні виклики та слухачі життєвого циклу, слухачі сутностей та підписники життєвого циклу);

    * `Документація по компоненту String <https://symfony.com/doc/current/components/string.html>`_;

    * `Контейнер сервісів<https://symfony.com/doc/current/service_container.html>` _;

    * `Шпаргалка по сервісах Symfony <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/services_en_42.pdf>`_.
