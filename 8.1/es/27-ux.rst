...
Upsun permite desplegar múltiples aplicaciones por proyecto. Se puede añadir otra aplicación creando un archivo ``.symfony.cloud.yaml`` en cualquier subdirectorio. Crea uno bajo ``spa/`` llamado ``spa``:
