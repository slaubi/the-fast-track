...
По умолчанию Blackfire добавлен во все проекты на Upsun.
...
Профилирование API лучше выполнять в командной строке с помощью установленного ранее инструмента Blackfire CLI:
...
На Upsun также возможно `запускать сценарии`_ при создании новой ветки или развёртывании в продакшене, чтобы автоматически проверять производительность нового кода.
