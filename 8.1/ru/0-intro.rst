...
Стоит ли книга вашего времени теперь, когда LLM может написать код за вас? Я задавал себе этот вопрос, работая над этим изданием. Мой ответ — однозначное да. Я пользуюсь инструментами ИИ каждый день, и теперь они пишут почти весь мой код; но они не изменили того, что действительно важно. Вам по-прежнему нужно понимать архитектуру своего приложения, решать, что строить, проверять сгенерированный код и замечать то, что в нём едва уловимо неверно. Невозможно проверить код, который вы не понимаете; и невозможно направить инструмент к архитектуре, которую вы не можете себе представить. Смысл чтения книг — в способности судить, а не в ностальгии.

Способность судить требует понимания, а понимание — это именно то, что выстраивает эта книга: полную ментальную модель приложения Symfony, от первого коммита до продакшена. С этой моделью в голове, когда в следующий раз LLM сгенерирует для вас контроллер или обработчик Messenger, вы будете знать, верен ли он, и почему. Мы даже заставим одну из таких моделей работать внутри самого приложения — модерировать комментарии.
...
И последнее, но не менее важное: не стесняйтесь обращаться за помощью, если окажетесь в тупике. Вы можете попасть в непредвиденную ситуацию или столкнуться с опечаткой в вашем коде, которую возможно будет трудно найти и исправить. Задайте вопросы, у нас есть замечательное сообщество в `Slack`_ и на `GitHub`_.
