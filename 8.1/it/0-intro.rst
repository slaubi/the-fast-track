...
Infine, non bisogna esitare a chiedere aiuto in caso di difficoltà. Ci si può imbattere in un caso limite, o in un errore di battitura difficile da scovare e correggere. C'è una splendida comunità su `Slack`_ e su `Github`_, è bello farne parte per ricevere aiuto o dare una mano.
...
.. _`containerizzazione`: https://en.wikipedia.org/wiki/OS-level_virtualization
