...
Per evitare di avere un file di configurazione che descriva quali eventi un listener vuole ascoltare, aggiungere l'attributo ``#[AsEventListener]`` sulla classe o sul metodo del listener. Questo permette ai listener di registrarsi automaticamente nel dispatcher di Symfony.
...
Ormai conoscete la canzone a memoria, usate MakerBundle per generare un listener:
...
.. sidebar:: Andare oltre
    ...
    * Il `flusso di Request-Response`_ nelle applicazioni Symfony;

    * Gli `eventi HTTP predefiniti di Symfony`_;

    * Gli `eventi predefiniti di Symfony Console`_.

.. _`flusso di Request-Response`: https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request
.. _`eventi HTTP predefiniti di Symfony`: https://symfony.com/doc/current/reference/events.html
.. _`eventi predefiniti di Symfony Console`: https://symfony.com/doc/current/components/console/events.html
