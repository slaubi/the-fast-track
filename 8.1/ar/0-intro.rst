...
وأخيراً وليس أخراً، لا تتردد في طلب المساعدة اذا واجتهك مشكلة. قد تصل إلي حالة طرفية (edge-case) أو خطئ مطبعي في الكود الذي كتبته ويكون من الصعب إيجاده وحله. إطرح أسئلتك. لدينا مجتمع رائع علي `Slack`_ و `GitHub`_.
