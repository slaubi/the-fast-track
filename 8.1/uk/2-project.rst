...
Наш *проект* буде містити декілька *застосунків*. Це буде традиційний веб-сайт з HTML на фронт-енді, який відчувається таким же швидким, як SPA, та API, готовий живити мобільні застосунки. Як вам це?
