...
За замовчуванням його значення, що визначено у ``.env``, дозволяє HTTP-запити від ``localhost`` і ``127.0.0.1`` на будь-який порт. Адаптуйте його, коли застосунок, розміщений в іншому домені, як-от мобільний застосунок або зовнішній фронт-енд, має викликати API.
