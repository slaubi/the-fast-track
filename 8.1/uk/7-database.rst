...
Для продакшн-інфраструктури у Upsun додавання такого сервісу, як PostgreSQL, виконується у файлі ``.platform/services.yaml``, що вже було зроблено за допомогою рецепту пакету ``webapp``:
