...
Клас ``SpamChecker`` покладається на аргумент ``$akismetKey``. Як і у випадку з каталогом для завантажених файлів, ми можемо ввести його за допомогою анотації ``Autowire``:
...
Ми, звичайно, не хочемо жорстко кодувати значення ключа Akismet у коді, натомість ми використовуємо змінну середовища (``AKISMET_KEY``).
