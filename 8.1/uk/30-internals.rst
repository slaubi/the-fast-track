...
Іншим способом стежити за виконанням коду є використання **покрокового налагоджувача**, як-от `Xdebug`_. Покроковий налагоджувач дозволяє розробникам інтерактивно проходити по коду проекту PHP для налагодження потоку управління і вивчення структур даних. Це дуже корисно для налагодження неочікуваної поведінки, і замінює поширений метод налагодження "var_dump()/exit()".
...
Якщо ви новачок у покроковому налагодженні, прочитайте `навчальний посібник із Visual Studio Code`_, де все пояснюється візуально.

.. sidebar:: Йдемо далі

    * `Документація по покроковому налагоджувачу Xdebug`_;

    * `Налагодження за допомогою Visual Studio Code`_.

.. _`Xdebug`: https://xdebug.org
.. _`PHP Debug`: https://marketplace.visualstudio.com/items?itemName=felixfbecker.php-debug
.. _`Документація по покроковому налагоджувачу Xdebug`: https://xdebug.org/docs/step_debug
.. _`навчальний посібник із Visual Studio Code`: https://code.visualstudio.com/Docs/editor/debugging
.. _`Налагодження за допомогою Visual Studio Code`: https://code.visualstudio.com/Docs/editor/debugging
