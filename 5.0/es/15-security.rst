...
.. tip::
    ...
    ¿Cómo sé que la ruta de EasyAdmin es ``easyadmin``? No lo sé. Pero he ejecutado el siguiente comando que muestra la asociación entre los nombres de ruta y las rutas:
