...
.. sidebar:: Verder gaan
    ...
    * De `Faker library <https://github.com/fzaninotto/Faker>`_ om realistische fixture data te genereren;

    * De `CssSelector component docs <https://symfony.com/doc/current/components/css_selector.html>`_;

    * De `Symfony Panther library <https://github.com/symfony/panther>`_ voor browser tests en web crawling in Symfony applicaties:

    * De `Make/Makefile docs <https://www.gnu.org/software/make/manual/make.html>`_.
