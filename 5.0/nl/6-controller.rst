...
.. sidebar:: Verder gaan
    ...
    * Het Symfony `routing <https://symfony.com/doc/current/routing.html>`_-systeem;
    ...
    * Het `HttpFoundation <https://symfony.com/doc/current/components/http_foundation.html>`_-component;

    * `XSS (Cross-Site Scripting) <https://owasp.org/www-community/attacks/xss/>`_ beveiligingsaanvallen;

    * De `Symfony Routing Cheat Sheet <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/routing_en_part1.pdf>`_.
