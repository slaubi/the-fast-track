...
Op SymfonyCloud kan je `de scenario's <https://blackfire.io/docs/integrations/paas/symfonycloud#builds-level-enterprise>`_ ook `uitvoeren <https://blackfire.io/docs/integrations/paas/symfonycloud#builds-level-enterprise>`_ wanneer je een nieuwe branch aanmaakt of naar productie gaat deployen, om de prestaties van de nieuwe code automatisch te controleren.

.. sidebar:: Verder gaan

    * `Het Blackfire boek: PHP Code Performance uitgelegd <https://blackfire.io/book>`_;
