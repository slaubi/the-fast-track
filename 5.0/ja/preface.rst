...
この書籍は、世界中の人々から金銭的に `サポート <https://www.kickstarter.com/projects/fabpot/symfony-5-the-fast-track>`_ をしていただきました。感謝します。この書籍は、無料でオンラインで見ることもできますし、Symfony のカンファレンス中では紙の書籍も入手可能です。
