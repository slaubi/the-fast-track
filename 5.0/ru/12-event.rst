...
.. sidebar:: Двигаемся дальше
    ...
    * `Рабочий процесс запроса-ответа <https://symfony.com/doc/current/components/http_kernel.html#the-workflow-of-a-request>`_ в приложениях Symfony;

    * `Встроенные HTTP-события в Symfony <https://symfony.com/doc/current/reference/events.html>`_;

    * `Встроенные события Symfony Console <https://symfony.com/doc/current/components/console/events.html>`_.
