...
.. sidebar:: Indo Além
    ...
    * `Tutorial sobre API Platform do SymfonyCasts <https://symfonycasts.com/screencast/api-platform>`_;

    * Para ativar o suporte a GraphQL, execute ``composer require webonyx/graphql-php``, em seguida navegue até ``/api/graphql``.
