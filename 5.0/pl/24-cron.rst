...
.. sidebar:: Idąc dalej
    ...
    * `Składnia cron/crontab; <https://en.wikipedia.org/wiki/Cron>`

    * `Repozytorium Croncape'a <https://github.com/symfonycorp/croncape>`_;

    * `Polecenia Symfony Console <https://symfony.com/doc/current/console.html>`_;

    * `Ściągawka poleceń konsolowych Symfony <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/console_en_42.pdf>`_.
