...
.. sidebar:: Idąc dalej
    ...
    * `Przepływy pracy i maszyny stanu <https://symfony.com/doc/current/workflow/workflow-and-state-machine.html>`_ oraz informacje, kiedy ich używać;

    * `Dokumentacja Symfony Workflow <https://symfony.com/doc/current/workflow.html>`_.
