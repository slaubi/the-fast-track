...
Spędź trochę czasu wyszukując idealny, staromodny i animowany GIF "W budowie" w Internecie. Ja zamierzam użyć `tego <http://clipartmag.com/images/website-under-construction-image-6.gif>`_:
...
Ja wybrałem `SymfonyCloud <https://symfony.com/cloud>`_. Dostarcza nam wszystkiego, czego potrzebujemy, i pomaga finansować rozwój Symfony.
...
.. sidebar:: Idąc dalej
    ...
    * `Serwer Symfony Recipe <https://flex.symfony.com/>`_, gdzie można znaleźć wszystkie dostępne przepisy dostępne dla aplikacji Symfony;

    * Repozytoria dla `oficjalnych przepisów Symfony <https://github.com/symfony/recipes>`_ i dla `przepisów przekazanych przez społeczność <https://github.com/symfony/recipes-contrib>`_, gdzie możesz zgłosić swoje własne przepisy;

    * `Lokalny serwer WWW Symfony <https://symfony.com/doc/current/setup/symfony_server.html>`_;

    * `Dokumentacja SymfonyCloud <https://symfony.com/doc/cloud>`_.
