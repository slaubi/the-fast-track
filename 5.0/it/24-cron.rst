...
.. sidebar:: Andare oltre
    ...
    * `Sintassi di cron e crontab <https://en.wikipedia.org/wiki/Cron>`_;

    * `Repository di Croncape <https://github.com/symfonycorp/croncape>`_;

    * `Comandi della console di Symfony <https://symfony.com/doc/current/console.html>`_;

    * `Cheat sheet della console di Symfony <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/console_en_42.pdf>`_.
