...
.. tip::
    ...
    Come faccio a sapere che il percorso per EasyAdmin è ``easyadmin``? Non lo so. Ma eseguire il seguente comando mostra l'associazione tra i nomi delle rotte e i percorsi:
