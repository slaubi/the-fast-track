...
Per creare l'applicazione mobile useremo `Preact`_ e **Symfony Encore**. **Preact** è una piccola ed efficiente libreria che semplificherà creazione della SPA del Guestbook.
...
.. sidebar:: Andare oltre
    ...
    * `Il sito ufficiale di Preact <https://preactjs.com/>`_;

    * `Il sito ufficiale di Cordova <https://cordova.apache.org/>`_.
