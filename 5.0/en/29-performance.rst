...
On your local machine, don't forget to disable the HTTP cache in ``public/index.php`` when profiling: if not, you will profile the Symfony HTTP cache layer instead of your own code:
