...
.. tip::
    ...
    How do I know that the EasyAdmin route is ``easyadmin``? I don't. But I ran the following command that shows the association between route names and paths:
...
.. sidebar:: Going Further
    ...
    * `How to Build a Login Form <https://symfony.com/doc/current/security/form_login_setup.html>`_ in Symfony applications;

    * The `Symfony Security Cheat Sheet <https://github.com/andreia/symfony-cheat-sheets/blob/master/Symfony4/security_en_44.pdf>`_.
