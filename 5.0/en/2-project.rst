...
As the book has to be released during SymfonyCon Amsterdam, it might be nice if the project is somehow related to Symfony and conferences. What about a `guestbook <https://en.wikipedia.org/wiki/Guestbook>`_? A livre d'or as we say in French. I like the old-fashioned and outdated feeling of developing a guestbook in 2019!
...
* 550 PHP Logical Lines of Code (LLOC) as reported by `PHPLOC <https://github.com/sebastianbergmann/phploc>`_;
