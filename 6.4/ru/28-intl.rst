...
.. sidebar:: Двигаемся дальше
    ...
    * `Перевод сообщений с использованием форматирования ICU`_;

    * `Использование Twig-фильтров перевода`_.

.. _`Перевод сообщений с использованием форматирования ICU`: https://symfony.com/doc/current/translation/message_format.html
.. _`Использование Twig-фильтров перевода`: https://symfony.com/doc/current/translation/templates.html#translation-filters
